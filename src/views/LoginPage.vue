...
// Reactive state để điều khiển việc lật container
const isContainerFlipped = ref(false)

// Method để toggle form quên mật khẩu
const showForgotPassword = () => {
  isContainerFlipped.value = !isContainerFlipped.value
}

// Cấu hình cho 20 ngôi sao mẫu, bạn có thể thêm hoặc sinh tự động nhiều hơn nếu muốn
const stars = [
                        ...
                        <div class="login-form">
                            ...
                            <form action="#">
                                <div class="input-boxes">
                                    ...
                                    <div class="text sign-up-text">Chưa có tài khoản? <label for="flip">Đăng ký ngay</label></div>
                                </div>
                            </form>
                        </div>
                        <div class="signup-form">
                            ...
                            <form action="#">
                                <div class="input-boxes">
                                    ...
                                    <div class="text sign-up-text">Đã có tài khoản? <label for="flip">Đăng nhập ngay</label></div>
                                </div>
                            </form>
                        </div>
                    </div>
